            ...
            <div class="panel-body">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('province_id', $provinces, array($user->province_id) , ['id' => 'province_id', 'class' => 'form-control'] ) !!}
                    </div>
                    ...
                    <div class="checkbox">
                        <label>
                            {{ Form::hidden('activate', 0) }}
                            {!! Form::checkbox('activate', 1,  $user->activations()->get()->first()->completed) !!}
                             Activate
                        </label>
                    </div>
